...
function App() {
  ...
  const handlebookService = async (status: string) => {
  ...
  return (
    <div className="w-full bg-white min-h-screen flex flex-col items-center  sm:p-4">
      <div className="w-full max-w-[760px] mx-auto">
        <div
          className="w-full h-[136px] sm:h-[200px] bg-red-200 bg-cover bg-center p-4 sm:p-8"
          style={{ backgroundImage: "url('/assets/service/foundm.png')" }}
        >
          <h1 className="text-[12px] text-[#1FC16B] italic font-bold leading-[20px] sm:leading-[26px] tracking-[0.01px] bg-white border flex w-fit p-1 rounded-3xl ">
            Normal Service
          </h1>
            ...
            <div className="space-y-2">
              ...
              <div className="flex w-full gap-2 justify-between ">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => handlebookService("cancelled")}
                    className="text-xs font-medium text-red-600 hover:text-red-700 transition-colors"
                  >
                    reject
                  </button>
                  <button
                    onClick={() => handlebookService("confirmed")}
