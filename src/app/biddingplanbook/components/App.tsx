    ...
    return (
        <div className='w-full bg-white min-h-screen flex flex-col items-center  sm:p-4'>
            ...
            <div className="w-full max-w-[760px] mx-auto">
                <div className="w-full h-[180px] sm:h-[200px] bg-red-200 bg-cover bg-center p-4 sm:p-8"
                    style={{ backgroundImage: "url('/assets/service/mobpremium.png')" }}>

                    <h1 className='text-[12px] text-[#DFB400] italic font-bold leading-[20px] sm:leading-[26px] tracking-[0.01px] bg-white border flex w-fit p-1 rounded-3xl '>Premium Service</h1>
                ...
                <div className="h-[calc(100vh-280px)] sm:h-[calc(100vh-320px)] overflow-y-auto space-y-2 p-2">
                    {providers.map((provider) => (
                        <div key={provider.id} className="w-full min-h-[180px] sm:h-[210px] bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 relative border border-gray-100 flex flex-col justify-center flex-shrink-0">
                        ...
                        <div className="flex items-center  gap-2 mb-3 sm:mb-4">
                            ...
                            <div>
                                ...
                                <span className="text-xs sm:text-sm text-gray-600">blueprints and building specifications...</span>
                            </div>
                        </div>
