...
function DeaktopDeatils({ isOpen, onClose, data }: DeaktopDeatilsProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className="w-[628px] h-[730px] bg-white rounded-lg p-6 relative shadow-lg">
