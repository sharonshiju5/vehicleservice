...
function LocationModal({ selectedLocation, onLocationSelect }: LocationModalProps) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                <IoIosArrowDown className={`text-[#3D155F] text-sm transition-transform duration-200 ${open ? 'rotate-180' : ''}`} />
            </div>
                    ...
                    <div className="border-b border-gray-100 space-y-2">
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <div className="text-xs text-gray-500">Get precise location automatically</div>
                            </div>
                        </button>
                    </div>
