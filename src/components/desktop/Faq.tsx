    ...
    <div className="w-full  mx-auto mt-6 pb-18">
      ...
      <div className="space-y-3">
        {faqData.map((faq, index) => (
          <div
            key={index}
            className="border border-gray-300 rounded-xl p-4 min-h-[90px] bg-white"
          >
            ...
            {activeIndex === index && (
              <p className="text-gray-500 font-normal text-xs leading-[18px] tracking-[0.03px]">{faq.answer}</p>
            )}
          </div>
        ))}
      </div>
